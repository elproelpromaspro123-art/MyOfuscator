return {
	...
	MBAObfuscation            = require("prometheus.steps.MBAObfuscation");
	AdvancedControlFlow       = require("prometheus.steps.AdvancedControlFlow");
	AdvancedOpaquePredicates  = require("prometheus.steps.AdvancedOpaquePredicates");
	MultiLayerStringEncryption = require("prometheus.steps.MultiLayerStringEncryption");
	ReferenceHiding           = require("prometheus.steps.ReferenceHiding");
	DeadCodePolymorphism      = require("prometheus.steps.DeadCodePolymorphism");
}